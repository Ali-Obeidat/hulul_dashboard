...
class apiChartsController extends Controller
{
    public function index()
    {
        ...
        return  
            ['affiliatesNum'=>$affiliatesNum,
            'maxAffiliatesCount'=> $maxAffiliatesCount,
            'twoWeeks'=> $twoWeeks,
            'userNum'=> $userNum,
            'maxUserCount'=> $maxUserCount,
            'WithdrawNum'=> $WithdrawNum,
            'maxWithdrawCount'=> $maxWithdrawCount,
            'maxVisitorsCount'=> $maxVisitorsCount,
            'visitorsNum'=> $visitorsNum,
            'maxDepositsCount'=> $maxDepositsCount,
            'DepositsNum'=> $DepositsNum,
            'maxWithdrawalsSumNum'=> $maxWithdrawalsSumNum,
            'WithdrawalsSumNum'=> $WithdrawalsSumNum,
            'finalTen'=> $finalTen,
            'CompaniesNum'=> $CompaniesNum,
            'maxCompaniesNum'=> $maxCompaniesNum,
            'finalCountriesNum'=> $finalCountriesNum,
            'finalFiveCountries'=> $finalFiveCountries
            ];
    }
}
