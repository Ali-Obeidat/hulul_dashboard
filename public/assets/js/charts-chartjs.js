!(function () {
            ...
            (a &&
                new Chart(a, {
                    ...
                    options: {
                        ...
                        scales: {
                            x: {
                                grid: { color: i, borderColor: i },
                                ticks: { color: e },
                            },
                            y: {
                                min: 0,
                                max: maxWithdrawCount +3,
                                grid: { color: i, borderColor: i },
                                ticks: {
                                    stepSize: maxWithdrawCount,
                                    tickColor: i,
                                    color: e,
                                },
                            },
    ...
    if (n) {
        const d = n.getContext("2d").createLinearGradient(0, 0, 0, 150),
            s =
                (d.addColorStop(0, "rgba(85, 85, 255, 0.9)"),
                d.addColorStop(1, "rgba(151, 135, 255, 0.8)"),
                n.getContext("2d").createLinearGradient(0, 0, 0, 150));
        s.addColorStop(0, "rgba(255, 85, 184, 0.9)"),
            s.addColorStop(1, "rgba(255, 135, 135, 0.8)");
        new Chart(n, {
            type: "radar",
            data: {
            ...
            options: {
                ...
                scales: {
                    r: {
                        ticks: { maxTicksLimit: 1, display: !1, color: e },
                        grid: { color: i },
                        angleLines: { color: i },
                        pointLabels: { color: e },
                    },
    ...
    (a = document.getElementById("polarChart")),
        a &&
            new Chart(a, {
                type: "polarArea",
                data: {
        ...
        (a = document.getElementById("bubbleChart")),
        a &&
            new Chart(a, {
                type: "bubble",
                data: {
                ...
                options: {
                    ...
                    scales: {
                        x: {
                            ...
                            max: 140,
                            grid: { color: i, borderColor: i },
                            ticks: { stepSize: 10, color: e },
                        },
                        y: {
                            min: 0,
                            max: 400,
                            grid: { color: i, borderColor: i },
                            ticks: { stepSize: 100, color: e },
                        },
                    },
                    plugins: {
                        legend: { display: !1 },
        ...
        (a = document.getElementById("doughnutChart")),
        a &&
            new Chart(a, {
                type: "doughnut",
                data: {
        ...
        (o = document.getElementById("scatterChart")),
        o &&
            new Chart(o, {
                type: "scatter",
                data: {
                ...
                options: {
                    ...
                    scales: {
                        x: {
                            min: 0,
                            max: 140,
                            grid: { color: i, drawTicks: !1, borderColor: i },
                            ticks: { stepSize: 10, color: e },
                        },
                        y: {
                            min: 0,
    ...
    a &&
        new Chart(a, {
            ...
            options: {
                ...
                scales: {
                    x: {
                        grid: { color: "transparent", borderColor: i },
                        ticks: { color: e },
                    },
                    y: {
                        min: 0,
