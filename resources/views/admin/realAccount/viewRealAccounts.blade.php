<x-admin-master>
    ...
    <div class="container-xxl flex-grow-1 container-p-y" style="padding-left: 85px; padding-right: 85px;">
        ...
        <h4 class="fw-bold py-3 mb-4">
            <span class="fw-light">Accounts /</span> Real Accounts
        </h4>
                ...
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{route('activatedRealAccount',$value['id'])}}" method="post">
                                    @csrf
                                    @method('PUT')
                                    <button type="button" class="btn rounded-pill ">Activate</button>
                                </form>
                            </td>
                            <td>
