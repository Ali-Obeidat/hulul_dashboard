<x-admin-master>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4"><span class="fw-light">Managers/</span> Create Managers</h4>

        <!-- Basic Layout -->


        @if(Session('manager_updated'))
        <div class="alert alert-primary alert-dismissible col-6" role="alert">
            ...
            <p class="mb-0">You successfully Edited the manager.</p>
        ...
        <div class="card col-md-10 col-lg-10  m-auto ">
            <h5 class="card-header">Enter manager information</h5>
            <form class="card-body" action="{{route('Managers.update',$manager->id)}}" method="post">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label" for="multicol-first-name">Name</label>
                        <input value="{{$manager->name}}" name="name" type="text" id="multicol-first-name" class="form-control form-control @error('name') is-invalid @enderror" placeholder="John" />
                        @error('name')
                    ...
                    <div class="col-md-6">
                        ...
                        <input value="{{$manager->email}}" name="email" type="email" id="multicol-last-name" class="form-control form-control @error('email') is-invalid @enderror" placeholder="Ex:Doe@gmail.com" />
                        @error('email')
                        <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        <div class="form-password-toggle">
                            <label class="form-label" for="multicol-confirm-password">Password</label>
                            <div class="input-group input-group-merge">
                                <input type="password" name="password" id="multicol-confirm-password" class="form-control form-control @error('password') is-invalid @enderror" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="multicol-confirm-password2" />
                    ...
                    <div class="col-md-6 select2-primary">
                        <label class="form-label" for="multicol-language">Roles</label>
                        <select name="role" id="multicol-language" class="select2 form-select" multiple>
