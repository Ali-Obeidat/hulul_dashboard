<x-admin-master>
    ...
    <div class="container-xxl flex-grow-1 container-p-y" style="padding-left: 85px; padding-right: 85px;">
        ...
        <div style="">
            ...
            <a href="{{route('public-Bonus.create')}}"> <button class="btn rounded-pill  mb-2">Create New Bonus</button> </a>
        </div>
                ...
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$bonus->status}}</td>
                            <td>
                                <a href="{{route('public-Bonus.edit',$bonus->id)}}">
                                    <button type="button" class="btn rounded-pill ">Edit</button>
                                </a>
                            </td>
                            <td>
                                <form action="{{route('public-Bonus.destroy',$bonus->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
